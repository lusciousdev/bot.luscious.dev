...
class LusciousBot(discord.Client):
  ...
  def __init__(self, channel_id : int, msg_id : int, message : str, *args, **kwargs):
  ...
  async def on_ready(self):
    ...
    await message.edit(content = self.message)
...
if __name__ == "__main__":
  ...
  bot = LusciousBot(args.channel, args.msgid, args.msg, intents = intents)
