...
class TwitchConfig(models.Model):
    ...
    owner_id = models.CharField(max_length=256, default="")
    provider = models.CharField(max_length=256, default = "twitch")
...
class TwitchCommand_A(Command_A):
    ...
    cooldown_while_offline = models.IntegerField(
        verbose_name="Cooldown in seconds (offline)", default=60
    )
